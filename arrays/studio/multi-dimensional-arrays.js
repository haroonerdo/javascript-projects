...
cabinetNo=input.question("Cabinet no: ")
}
...
let cabinetNo=2; //I need cabinet number from user
if((cabinetNo>=0)&&(cabinetNo<=3)){
    console.log("The caabinet's contents has: ")
    console.log(arrCargoHold[cabinetNo]);
}else{
...
function ask(){
    const input = require('readline-sync');
    let question1="Which item are you looking for? ";
    let item="";
    
    item=input.question("Item name: ")
    let i=0;
